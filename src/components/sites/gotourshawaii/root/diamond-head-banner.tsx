    ...
    <section id="diamond-head" className="relative bg-[#f5f0e8] pb-16 sm:pb-24 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div
          ...
          className="group relative h-[400px] sm:h-[480px] md:h-[530px] rounded-3xl overflow-hidden shadow-2xl cursor-pointer transition-all duration-300 transform hover:-translate-y-1"
        >
          ...
          <div className="absolute top-6 right-6 sm:top-8 sm:right-8 md:top-10 md:right-10 z-10 w-24 h-24 sm:w-32 sm:h-32 md:w-36 md:h-36 drop-shadow-2xl transition-transform duration-300 group-hover:rotate-6 group-hover:scale-105">
            <Image
