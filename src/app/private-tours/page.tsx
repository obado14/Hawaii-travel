...
import { Users, Shield, Calendar, Sparkles, CheckCircle } from "lucide-react";
        ...
        <section className="bg-[#f5f0e8] text-neutral-900 py-12 sm:py-16 px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white rounded-2xl p-7 sm:p-8 shadow-lg border border-neutral-200/80 transition-shadow hover:shadow-xl">
          ...
          <div className="max-w-4xl mx-auto bg-white/5 border border-white/10 rounded-3xl p-6 sm:p-10 backdrop-blur-md">
            ...
            {quoteSent ? (
              ...
              >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  <div>
                    ...
                    <input
                      type="date"
                      required
                      className="w-full bg-[#0c1f38]/90 border border-white/20 hover:border-white/35 rounded-xl px-3 py-2 text-sm text-white focus:outline-none focus:border-[#f15d22] focus:ring-2 focus:ring-[#f15d22]/40 transition-all duration-200"
                    />
                  </div>
                  <div>
                    <label className="block text-xs uppercase font-semibold text-neutral-300 mb-1.5">
                  ...
                  <div>
                    ...
                    <select className="w-full bg-[#0c1f38]/90 border border-white/20 hover:border-white/35 rounded-xl px-3 py-2 text-sm text-white focus:outline-none focus:border-[#f15d22] focus:ring-2 focus:ring-[#f15d22]/40 transition-all duration-200 cursor-pointer">
                ...
                <button
                  type="submit"
                  className="w-full bg-[#f15d22] hover:bg-[#d84b13] text-white font-heading text-lg font-bold uppercase tracking-wider py-3.5 rounded-xl shadow-lg shadow-[#f15d22]/25 hover:shadow-xl hover:shadow-[#f15d22]/40 hover:-translate-y-0.5 active:translate-y-0 transition-all duration-200 cursor-pointer"
                >
